...
static constexpr auto number_of_floating_point_variables = 45;
namespace {
template <typename T>
...
#define mg _ml->template fpfield<7>(_iml)
#define mg_columnindex 7
#define u0 _ml->template fpfield<8>(_iml)
#define u0_columnindex 8
#define Nrrp _ml->template fpfield<9>(_iml)
...
#define selected_for_report _ml->template fpfield<12>(_iml)
#define selected_for_report_columnindex 12
#define NMDA_ratio _ml->template fpfield<13>(_iml)
#define NMDA_ratio_columnindex 13
#define conductance _ml->template fpfield<14>(_iml)
#define conductance_columnindex 14
#define i _ml->template fpfield<15>(_iml)
#define i_columnindex 15
#define i_AMPA _ml->template fpfield<16>(_iml)
#define i_AMPA_columnindex 16
#define i_NMDA _ml->template fpfield<17>(_iml)
#define i_NMDA_columnindex 17
#define g_AMPA _ml->template fpfield<18>(_iml)
#define g_AMPA_columnindex 18
#define g_NMDA _ml->template fpfield<19>(_iml)
#define g_NMDA_columnindex 19
#define g _ml->template fpfield<20>(_iml)
#define g_columnindex 20
#define A_AMPA_step _ml->template fpfield<21>(_iml)
#define A_AMPA_step_columnindex 21
#define B_AMPA_step _ml->template fpfield<22>(_iml)
#define B_AMPA_step_columnindex 22
#define A_NMDA_step _ml->template fpfield<23>(_iml)
#define A_NMDA_step_columnindex 23
#define B_NMDA_step _ml->template fpfield<24>(_iml)
#define B_NMDA_step_columnindex 24
#define unoccupied _ml->template fpfield<25>(_iml)
#define unoccupied_columnindex 25
#define occupied _ml->template fpfield<26>(_iml)
#define occupied_columnindex 26
#define tsyn _ml->template fpfield<27>(_iml)
#define tsyn_columnindex 27
#define u _ml->template fpfield<28>(_iml)
#define u_columnindex 28
#define next_delay _ml->template fpfield<29>(_iml)
#define next_delay_columnindex 29
#define A_AMPA _ml->template fpfield<30>(_iml)
#define A_AMPA_columnindex 30
#define B_AMPA _ml->template fpfield<31>(_iml)
#define B_AMPA_columnindex 31
#define A_NMDA _ml->template fpfield<32>(_iml)
#define A_NMDA_columnindex 32
#define B_NMDA _ml->template fpfield<33>(_iml)
#define B_NMDA_columnindex 33
#define factor_AMPA _ml->template fpfield<34>(_iml)
#define factor_AMPA_columnindex 34
#define factor_NMDA _ml->template fpfield<35>(_iml)
#define factor_NMDA_columnindex 35
#define mggate _ml->template fpfield<36>(_iml)
#define mggate_columnindex 36
#define usingR123 _ml->template fpfield<37>(_iml)
#define usingR123_columnindex 37
#define DA_AMPA _ml->template fpfield<38>(_iml)
#define DA_AMPA_columnindex 38
#define DB_AMPA _ml->template fpfield<39>(_iml)
#define DB_AMPA_columnindex 39
#define DA_NMDA _ml->template fpfield<40>(_iml)
#define DA_NMDA_columnindex 40
#define DB_NMDA _ml->template fpfield<41>(_iml)
...
#define _tsav _ml->template fpfield<44>(_iml)
...
static void nrn_alloc(Prop* _prop) {
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    size_t const _iml{};
    assert(_nrn_mechanism_get_num_vars(_prop) == 45);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"mg"} /* 7 */,
                                       _nrn_mechanism_field<double>{"u0"} /* 8 */,
                                       _nrn_mechanism_field<double>{"Nrrp"} /* 9 */,
                                       _nrn_mechanism_field<double>{"synapseID"} /* 10 */,
                                       _nrn_mechanism_field<double>{"verboseLevel"} /* 11 */,
                                       _nrn_mechanism_field<double>{"selected_for_report"} /* 12 */,
                                       _nrn_mechanism_field<double>{"NMDA_ratio"} /* 13 */,
                                       _nrn_mechanism_field<double>{"conductance"} /* 14 */,
                                       _nrn_mechanism_field<double>{"i"} /* 15 */,
                                       _nrn_mechanism_field<double>{"i_AMPA"} /* 16 */,
                                       _nrn_mechanism_field<double>{"i_NMDA"} /* 17 */,
                                       _nrn_mechanism_field<double>{"g_AMPA"} /* 18 */,
                                       _nrn_mechanism_field<double>{"g_NMDA"} /* 19 */,
                                       _nrn_mechanism_field<double>{"g"} /* 20 */,
                                       _nrn_mechanism_field<double>{"A_AMPA_step"} /* 21 */,
                                       _nrn_mechanism_field<double>{"B_AMPA_step"} /* 22 */,
                                       _nrn_mechanism_field<double>{"A_NMDA_step"} /* 23 */,
                                       _nrn_mechanism_field<double>{"B_NMDA_step"} /* 24 */,
                                       _nrn_mechanism_field<double>{"unoccupied"} /* 25 */,
                                       _nrn_mechanism_field<double>{"occupied"} /* 26 */,
                                       _nrn_mechanism_field<double>{"tsyn"} /* 27 */,
                                       _nrn_mechanism_field<double>{"u"} /* 28 */,
                                       _nrn_mechanism_field<double>{"next_delay"} /* 29 */,
                                       _nrn_mechanism_field<double>{"A_AMPA"} /* 30 */,
                                       _nrn_mechanism_field<double>{"B_AMPA"} /* 31 */,
                                       _nrn_mechanism_field<double>{"A_NMDA"} /* 32 */,
                                       _nrn_mechanism_field<double>{"B_NMDA"} /* 33 */,
                                       _nrn_mechanism_field<double>{"factor_AMPA"} /* 34 */,
                                       _nrn_mechanism_field<double>{"factor_NMDA"} /* 35 */,
                                       _nrn_mechanism_field<double>{"mggate"} /* 36 */,
                                       _nrn_mechanism_field<double>{"usingR123"} /* 37 */,
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 38 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 39 */,
                                       _nrn_mechanism_field<double>{"DA_NMDA"} /* 40 */,
                                       _nrn_mechanism_field<double>{"DB_NMDA"} /* 41 */,
                                       _nrn_mechanism_field<double>{"v"} /* 42 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 43 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 44 */,
 ...
 pnt_receive_size[_mechtype] = 5;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbAMPANMDA_EMS /mnt/mydata/cerebellum/mod/ProbAMPANMDA_EMS.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/cerebellum/mod/ProbAMPANMDA_EMS.mod";
