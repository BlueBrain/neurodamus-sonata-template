...
#define t _nt->_t
#define dt _nt->_dt
#define vthresh _ml->template fpfield<0>(_iml)
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ThreshDetect_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"vthresh"} /* 0 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ThreshDetect /mnt/mydata/cerebellum/mod/ThreshDetect.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/cerebellum/mod/ThreshDetect.mod";
