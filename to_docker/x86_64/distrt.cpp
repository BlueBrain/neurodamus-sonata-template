...
#define t _nt->_t
#define dt _nt->_dt
#define flag _ml->template fpfield<0>(_iml)
#define flag_columnindex 0
#define vpre _ml->template fpfield<1>(_iml)
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"flag"} /* 0 */,
                                       _nrn_mechanism_field<double>{"vpre"} /* 1 */,
                                       _nrn_mechanism_field<double>{"v"} /* 2 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 3 */);
  hoc_register_prop_size(_mechtype, 4, 0);
 
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 th /mnt/mydata/cerebellum/mod/distrt.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "...just to signal thr crossing";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/cerebellum/mod/distrt.mod";
