...
#define fbetm fbetm__kdrmt 
#define falpm falpm__kdrmt 
...
#define q10 _ml->template fpfield<2>(_iml)
#define q10_columnindex 2
#define alpm _ml->template fpfield<3>(_iml)
#define alpm_columnindex 3
#define betm _ml->template fpfield<4>(_iml)
#define betm_columnindex 4
...
#define _ion_dikdv *(_ml->dptr_field<2>(_iml))
 ...
 static void _hoc_fbetm(void);
 static void _hoc_falpm(void);
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"fbetm_kdrmt", _hoc_fbetm},
 {"falpm_kdrmt", _hoc_falpm},
 {"trates_kdrmt", _hoc_trates},
 {0, 0}
};
 
/* Direct Python call wrappers to density mechanism functions.*/
 static double _npy_fbetm(Prop*);
 static double _npy_falpm(Prop*);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"q10"} /* 2 */,
                                       _nrn_mechanism_field<double>{"alpm"} /* 3 */,
                                       _nrn_mechanism_field<double>{"betm"} /* 4 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kdrmt /mnt/mydata/cerebellum/mod/kdrmt.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "K-DR";

static int error;
static int _ninits = 0;
static int _match_recurse=1;
static void _modl_cleanup(){ _match_recurse=1;}
static int fbetm(_internalthreadargsprotocomma_ double);
static int falpm(_internalthreadargsprotocomma_ double);
...
static int  trates ( _internalthreadargsprotocomma_ double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 24.0 ) / 10.0 ) ) ;
   ...
   falpm ( _threadargscomma_ _lv ) ;
   fbetm ( _threadargscomma_ _lv ) ;
   mtau = betm / ( _lqt * a0m * ( 1.0 + alpm ) ) ;
    return 0; }
...
static void _hoc_trates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for trates_kdrmt. Requires prior call to setdata_kdrmt and that the specified mechanism instance still be in existence.", NULL);
  }
...
static int  falpm ( _internalthreadargsprotocomma_ double _lv ) {
   alpm = exp ( zetam * ( _lv - vhalfm ) ) ;
    return 0; }
...
static void _hoc_falpm(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for falpm_kdrmt. Requires prior call to setdata_kdrmt and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
_nt = nrn_threads;
 _r = 1.;
 falpm ( _threadargscomma_ *getarg(1) );
 hoc_retpushx(_r);
}
 
static double _npy_falpm(Prop* _prop) {
    double _r{0.0};
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 _nrn_mechanism_cache_instance _ml_real{_prop};
auto* const _ml = &_ml_real;
...
static int  fbetm ( _internalthreadargsprotocomma_ double _lv ) {
   betm = exp ( zetam * gmm * ( _lv - vhalfm ) ) ;
    return 0; }
...
static void _hoc_fbetm(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for fbetm_kdrmt. Requires prior call to setdata_kdrmt and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
_nt = nrn_threads;
 _r = 1.;
 fbetm ( _threadargscomma_ *getarg(1) );
 hoc_retpushx(_r);
}
 
static double _npy_fbetm(Prop* _prop) {
    double _r{0.0};
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 _nrn_mechanism_cache_instance _ml_real{_prop};
auto* const _ml = &_ml_real;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/cerebellum/mod/kdrmt.mod";
